...
class EmployeeModel {
  ...
  static EmployeeModel fromJson(Map<String, dynamic> json) {
    return EmployeeModel(
      ...
      reportingOfficer: json['reportingOfficer']?.toString() ?? json['reporting_officer']?.toString() ?? '',
      reportingOfficer1: json['reportingOfficer1']?.toString() ?? json['reporting_officer_1']?.toString() ?? '',
      reportingOfficerName: json['reportingOfficerName']?.toString() ?? json['reporting_officer_name']?.toString() ?? '',
      reportingOfficer1Name: json['reportingOfficer1Name']?.toString() ?? json['reporting_officer_1_name']?.toString() ?? '',
